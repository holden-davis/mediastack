...
export FOLDER_FOR_YAMLS=/docker/mediastack      # <-- Folder where the yaml and .env files are located
export FOLDER_FOR_MEDIA=/mnt/media              # <-- Folder where your media is located
